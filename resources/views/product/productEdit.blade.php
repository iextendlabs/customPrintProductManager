          ...
          <div class="content-wrapper">
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                <div class="card-body">
                <a href="{{url('/productList')}}"><div class="badge badge-outline-primary float-end">Home</div></a>
                    ...
                    <form action="updateProduct" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                      ...
                      <a href="{{url('/productList')}}"><button type="button" data-toggle="tooltip" title="Cancel" class="badge badge-outline-warning">Cancel</button></a>
                    </form>
                  </div>
                </div>
              </div>
